...
export const generateQrCode = async (designID: number, totalPrice: number, orderOption: string, orderType: OrderTypes, quantity: number, color: number, size: number): Promise<ProceedPaymentResponseData> =>  {
