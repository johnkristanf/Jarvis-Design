               ...
               <div class="flex items-center justify-between w-full">
                  ...
                  <div class="hidden md:block">
                     <div class="ml-6 flex items-baseline space-x-4">
                        <router-link
                           v-for="item in navigation.filter((nav) => !['Orders', 'Message'].includes(nav.name) || authStore.currentUser)"
                           :key="item.name"
                           :to="item.to"
                              ...
                              <div class="flex flex-col gap-1">
                                 ...
                                 >
                                    <div class="flex flex-col text-sm gap-1">
                                       <OrderMessages :status="notif.orders.status" :product_name="notif.orders.product?.name" />
                                       ...
                                       <OrderDate :delivery_date="notif.orders.delivery_date" :status="notif.status" />
