...
<script lang="ts" setup>
    ...
    const handleMarkAllAsRead = () => {
        const isAdmin = false // flag for different notification database model
...
<template>
                                        ...
                                        <div class="flex flex-col gap-5">
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        v-if="!notif.is_read"
                                                        class="absolute top-3 right-4 w-2 h-2 bg-yellow-600 rounded-full flex-shrink-0 mt-1"
                                                    ></div>
    ...
    <Loader v-if="authStore.LoggingOut" msg="Logging Out..." />
