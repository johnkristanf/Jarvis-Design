<script lang="ts" setup>
    ...
    import type { MaterialsCategory, MaterialFormValues } from '@/types/materials'
                ...
                <div class="mb-4">
                     ...
                     <div class="flex items-center gap-1 relative">
                        ...
                        <div
                            id="quantity-tooltip"
                            role="tooltip"
                            class="absolute z-[999999] invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700"
                        >
