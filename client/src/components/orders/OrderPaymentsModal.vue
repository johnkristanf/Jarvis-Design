...
<template>
    <Dialog :open="true" @close="handleCloseModal" class="fixed inset-0 z-[999] flex items-center justify-center bg-gray-900/70">
            ...
            <div class="bg-white max-h-[90vh] overflow-hidden rounded-2xl shadow-2xl">
                ...
                <div class="p-6">
                    ...
                    <div v-else-if="error" class="text-center py-12">
                        ...
                        <h3 class="text-lg font-medium text-gray-900 mb-2">Failed to load payments</h3>
                        ...
                        <div class="max-h-96 overflow-y-auto space-y-4">
                            ...
                            >
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">Amount Applied</label>
                                        ...
                                        <div v-else class="flex space-x-2">
                                            ...
                                            >
                                                <svg v-if="isUpdating(payment.id)" class="animate-spin h-4 w-4" fill="none" viewBox="0 0 24 24">
                                    ...
                                    <div>
                                        ...
                                        <div class="bg-gray-50 rounded-lg p-3">
                                            <span class="text-gray-900">{{ payment.payment_methods.name }}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center justify-between text-sm text-gray-500 pt-4 border-t border-gray-200">
                                    <span>Paid At: {{ formatDateWithTime(payment.created_at) }}</span>
                                    <span>Updated At: {{ formatDateWithTime(payment.updated_at) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
