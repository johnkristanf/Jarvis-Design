<script lang="ts" setup>
    ...
    const profileSchema = yup.object({
        ...
        password: yup
            .string()
            .nullable()
            .transform((value) => (value === '' || value === null ? null : value)) // handle empty string and null
            .when([], {
    ...
    <div class="min-[90vh] bg-gray-50">
        ...
        <div class="max-w-4xl mx-auto px-4 py-5">
            ...
            <div v-else class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <!-- Form Header -->
                <div class="px-6 py-4 border-b border-gray-200 bg-gray-900 text-white">
        ...
        <Loader v-if="isLoadingMutation" msg="Updating Profile" />
    </div>
</template>
