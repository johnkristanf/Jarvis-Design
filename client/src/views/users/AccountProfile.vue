...
<template>
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div class="bg-white border-b border-gray-200 dark:bg-gray-900 dark:border-gray-800">
            <div class="max-w-4xl mx-auto px-4 py-6">
                <div class="flex items-center space-x-4">
                    <div
                        class="w-16 h-16 bg-gray-900 rounded-full flex items-center justify-center dark:bg-gray-700"
                    >
        ...
        <div class="max-w-4xl mx-auto px-4 py-5">
            ...
            <div
                v-else
                class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden dark:bg-gray-800 dark:border-gray-700"
            >
                <!-- Form Header -->
                <div
                    class="px-6 py-4 border-b border-gray-200 bg-gray-900 text-gray-200 dark:border-gray-700"
                >
                    <h2 class="text-xl font-semibold text-white">Account Information</h2>
                    <p class="text-sm mt-1 text-gray-400">Update your personal details below</p>
                </div>
                ...
                <form @submit.prevent="handleUpdateProfile" class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input
                                v-model="name"
                                type="text"
                                class="w-full px-4 py-3 rounded-lg border transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent dark:focus:ring-gray-500 delay-100"
                                :class="{
                                    'border-gray-300 bg-white text-gray-900 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100':
                                        !nameError,
                                    'border-red-300 bg-red-50 text-red-900 dark:bg-red-900/20 dark:border-red-800 dark:text-red-300':
                                        nameError,
                                }"
                        ...
                        <div class="space-y-2 md:col-span-2">
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    class="w-full px-4 py-3 pr-12 rounded-lg border transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent dark:focus:ring-gray-500 delay-100"
                                    :class="{
                                        'border-gray-300 bg-white text-gray-900 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100':
                                            !passwordError,
                                        'border-red-300 bg-red-50 text-red-900 dark:bg-red-900/20 dark:border-red-800 dark:text-red-300':
                    ...
                    <!-- Form Actions -->
                    <div
                        class="flex flex-col sm:flex-row justify-between items-center pt-6 mt-6 border-t border-gray-200 dark:border-gray-700 space-y-3 sm:space-y-0"
                    >
                        <div class="flex items-center space-x-2">
                            <div
                                v-if="hasChanges"
                                class="flex items-center text-sm text-amber-600 dark:text-amber-400"
                            >
                                <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path
                                        fill-rule="evenodd"
                        ...
                        <div class="flex space-x-3">
                            <button
                                ...
                                class="px-6 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 dark:hover:bg-gray-600"
                            >
                                Reset Changes
                            </button>
                            ...
                            <button
                                ...
                                class="px-6 py-2.5 text-sm font-medium text-white bg-gray-900 rounded-lg hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 flex items-center dark:bg-white dark:text-gray-900 dark:hover:bg-gray-200"
                            >
                                <svg
        ...
        >
            <div
                class="bg-white rounded-lg p-6 flex items-center space-x-4 dark:bg-gray-800 border dark:border-gray-700"
            >
                <div
