...
<template>
    ...
    <div class="flex flex-col mt-10 px-6 lg:px-8 h-[90vh] ">
      <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <h2 class="mt-3 text-center text-2xl/9 font-bold tracking-tight text-white">Register to get started</h2>
      </div>
      ...
      <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" action="#" method="POST">
            ...
            <div>
                ...
                <div class="mt-2">
                <input type="text" name="name" id="email"required class="font-medium block w-full rounded-md bg-white px-3 py-1.5 text-base text-black outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-none sm:text-sm/6" />
                </div>
            </div>
